...
<main class="benevolat">
    <h2 aria-level="2" class="hidden">Bénévolat</h2>
    <?php $types = get_terms(['taxonomy' => 'type']); ?>
    <section class="benevolat__hero hero">
        <div class="hero__all">
            <div class="hero__desc--1 flex">
                <div class="hero__content">
                    <h3  aria-level="3" class="title hero__principaltitle"><?= get_field('benevolat_title')?></h3>
    ...
    <section class="benevolat__benevoles benevoles">
        <h3 aria-level="3" class="benevoles__principaltitle title">Nous recherchons des <span class="bold rect rect_violet">bénévoles !</span></h3>
    ...
    <section class="benevolat__benevolat benevolat">
        <h3 aria-level="3" class="hidden">Bénévolat</h3>
        <div class="benevolat__wrapper flex">
            <div class="benevolat__content flex column">
                <h4 aria-level="4" class="benevolat__title title"><?= get_field('benevolat_titre_3')?></h4>
